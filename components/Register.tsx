...
const faqs = [
  {
    ...
    answer: "Tidak ada biaya pendaftaran. Biaya pelatihan dikenakan per paket (umumnya 6x pertemuan) yang dibayarkan di awal, setelah program pelatihan disepakati dalam proses konsultasi dan asesmen."
  },
  {
  ...
  return (
    <div className="bg-white min-h-screen pt-28 pb-20">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <section className="max-w-3xl mx-auto bg-gray-50 rounded-3xl p-6 md:p-10 border border-gray-100 mb-12 scroll-mt-24" id="form-daftar">
